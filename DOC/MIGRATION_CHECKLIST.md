...
- [ ] بقية المخازن عبر `whenReal(() => api.x(), () => mock)` — مخزنًا بمخزن (التالي: Interviewers/Interviews → Surveys → Notifications → Wallet/Plan — بموارد مخصّصة)
- [x] تحقّق حيّ بعد كل مخزن (Auth ✓ · Profile ✓ · PublicProfile ✓ · Marketplace ✓)
